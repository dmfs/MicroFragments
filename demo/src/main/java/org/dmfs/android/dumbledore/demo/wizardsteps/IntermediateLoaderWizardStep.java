...
public final class IntermediateLoaderWizardStep implements WizardStep<Void>
{
    ...
    public Creator<IntermediateLoaderWizardStep> CREATOR = new Creator<IntermediateLoaderWizardStep>()
    {
        @Override
        public IntermediateLoaderWizardStep createFromParcel(Parcel source)
        {
            return new IntermediateLoaderWizardStep();
        }


        @Override
        public IntermediateLoaderWizardStep[] newArray(int size)
        {
            return new IntermediateLoaderWizardStep[size];
        }
    };
