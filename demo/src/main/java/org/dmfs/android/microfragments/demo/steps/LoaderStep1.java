...
public final class LoaderStep1 implements MicroWizard<Integer>
{
    ...
    private final static class WizardStepBox extends AbstractWizardStepBox<Integer, URI>
    {

        WizardStepBox(MicroWizard<URI> next)
        {
            super(next, LoaderStep1::new);
        }


        public final static Creator<MicroWizard<Integer>> CREATOR = new WizardStepCreator<>(LoaderStep1::new, LoaderStep1[]::new);
    }
}
