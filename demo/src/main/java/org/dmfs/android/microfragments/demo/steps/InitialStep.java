...
public final class InitialStep implements MicroWizard<Void>
{
    ...
    private final static class FollowUpMicroWizardBox extends AbstractFollowUpMicroWizardBox<Void, Integer>
    {
        FollowUpMicroWizardBox(MicroWizard<Integer> next)
        {
            super(next, InitialStep::new);
        }


        public final static Creator<MicroWizard<Void>> CREATOR = new FollowUpMicroWizardCreator<>(InitialStep::new, InitialStep[]::new);
    }
}
