...
public final class Step2 implements MicroWizard<URI>
{
    ...
    private final static class WizardStepBox extends AbstractWizardStepBox<URI, URI>
    {
        ...
        public final static Creator<MicroWizard<URI>> CREATOR = new WizardStepCreator<>(Step2::new, Step2[]::new);
    }
}
