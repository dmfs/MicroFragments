...
public final class FinalLoaderStep implements MicroWizard<URI>
{
    ...
    private final static class WizardStepBox extends AbstractWizardStepBox<URI, String>
    {

        WizardStepBox(MicroWizard<String> next)
        {
            super(next, FinalLoaderStep::new);
        }


        public final static Creator<MicroWizard<URI>> CREATOR = new WizardStepCreator<>(FinalLoaderStep::new, FinalLoaderStep[]::new);
    }
}
