...
public final class ForwardXFadeOperation extends AbstractWizardOperation
{
    ...
    public void apply(@NonNull Context context, @NonNull FragmentManager fragmentManager, @NonNull WizardStep previousStep)
    {
        ...
        if (useRtl(context))
        {
            transaction.setCustomAnimations(R.anim.dumbledore_wizard_fade_in, R.anim.dumbledore_wizard_fade_out, R.anim.dumbledore_wizard_enter_right,
                    R.anim.dumbledore_wizard_exit_left);
        }
        else
        {
            transaction.setCustomAnimations(R.anim.dumbledore_wizard_fade_in, R.anim.dumbledore_wizard_fade_out, R.anim.dumbledore_wizard_enter_left,
